...
function Admin() {
  ...
  const [charities, setCharities] = useState([]); // 🔥 NEW
  ...
  const [newCharity, setNewCharity] = useState(""); // 🔥 NEW
  ...
  const fetchAll = async () => {
    ...
    setSubscribers(activeUsers.length);
    setRevenue(activeUsers.length * 99);
